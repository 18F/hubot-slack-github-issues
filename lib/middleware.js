  ...
  var domain = that.slackClient.getTeamDomain(),
      ...
      messageWithReactions = {
        ...
        message: {
          ...
          reactions: message.item.message.reactions
        },
      };
  log(msgId + ': getting reactions for ' +
    messageWithReactions.message.permalink);
  return Promise.resolve(messageWithReactions);
}
